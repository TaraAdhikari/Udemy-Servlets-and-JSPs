...
<!-- it also breaks MVC because its not sending the result to the controller but sending to the jsps -->

<!-- while running this in same browser the session will save the cookies of email and password. so for that 
we can try in new incognito window -->